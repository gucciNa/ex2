	...
	.equ	NOTES_COUNT, 	488		@ ノーツ更新用のnotes_bufferの個数
	.equ	NOTES_SPEED,	TIMER_HZ/3	@ ノーツの渦を巻く早さ
	@ ノーツの合計　スコアを割合で算出するための定義
	.equ	NOTES_SUM, 	138		@ これは仮の数！　書き換え必須
...
sound_buffer:	@ 5: ド 7: ミ
	...
	@ 例) 0x4 | -> 0100(2) -> 左上のみ点灯
notes_buffer:
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@ kankan
	.byte 0, 0, 0, 0, 0, 0, 1, 0	@ 16 やっ
	.byte 0, 0, 0, 4, 0, 0, 0, 0	@    とめを
	.byte 0, 0, 0, 1, 0, 0, 0, 0 	@    さました
	.byte 4, 0, 0, 0, 0, 0, 0, 0	@    かい
	
	.byte 0, 0, 0, 0, 2, 0, 8, 0	@ 20 それ
	.byte 4, 0, 1, 0, 2, 0, 8, 0	@    なのになぜめもあ
	.byte 4, 0, 1, 0, 2, 0, 8, 0	@    わせやしないんだい?
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@    -
	
	.byte 0, 0, 0, 0, 0, 0, 0, 1	@ 24 「お
	.byte 4, 0, 0, 2, 8, 0, 0, 0	@    そいよ」と
	.byte 0, 0, 0, 4, 0, 0, 0, 1 	@    おこるき
	.byte 2, 0, 0, 0, 0, 0, 0, 0	@    み				/21
	
	.byte 0, 0, 0, 0, 8, 0, 4, 0	@ 28 これ
	.byte 1, 0, 2, 0, 8, 0, 4, 0	@    でもやれるだけと
	.byte 1, 0, 2, 0, 8, 0, 4, 0	@    ばしてきたんだよ
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@    -
	
	.byte 0, 0, 0, 0, 2, 0, 1, 0	@ 32 ここ
	.byte 4, 0, 8, 0, 2, 0, 1, 0	@    ろがからだをおい
	.byte 4, 0, 8, 0, 2, 0, 1, 0	@    こしてきたんだよ
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@    -
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@
	
	.byte 1, 0, 0, 4, 0, 0, 8, 0	@ 37 きみのかみやひと
	.byte 0, 2, 0, 0, 8, 0, 0, 4	@    みだけでむねがい
	.byte 0, 0, 0, 0, 0, 0, 1, 2	@    たいよ
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@    -
	
	.byte 1, 0, 0, 2, 0, 0, 8, 0	@ 41 おなじときをすい
	.byte 0, 4, 0, 0, 8, 0, 0, 2	@    こんではなしたく
	.byte 0, 0, 0, 0, 0, 0, 1, 4	@    ないよ
	
	.byte 0, 0, 0, 0, 0, 0, 8, 0	@ 44 - はる
	.byte 0, 0, 4, 0, 0, 0, 8, 0	@    かむかーしか
	.byte 0, 0, 0, 0, 0, 8, 0, 2	@    ーーらし
	.byte 0, 0, 1, 0, 0, 4, 0, 0	@    るそのーこえ
	
	.byte 1, 0, 0, 0, 0, 0, 0, 2	@ 48 に　う
	.byte 0, 0, 0, 0, 0, 8, 0, 0	@    まれてーはじ
	.byte 0, 0, 1, 0, 8, 0, 0, 0	@    ーめて
	
	.byte 15, 0, 0, 0, 0, 0, 0, 1	@ 51 なーに			/同時 + 5
	.byte 2, 0, 0, 0, 0, 0, 0, 4	@    をーい
	.byte 8, 0, 0, 0, 0, 0, 0, 3	@    えーば
	
	.byte 12, 0, 0, 0, 0, 0, 0, 0	@ 54 いい？　きみの
	.byte 1, 0, 2, 0, 1, 0, 2, 8	@    ぜんぜんぜんぜんせいか
	.byte 4, 1, 0, 2, 0, 0, 0, 0	@    らぼくはーきみを
	.byte 4, 0, 0, 8, 0, 0, 1, 2	@    さがしはじめたよ		/67+5
	
	.byte 0, 0, 0, 1, 0, 0, 0, 0	@ 58 ー　そのぶきっ
	.byte 0, 0, 0, 1, 0, 0, 0, 0	@    ーちょなわらいかた
	.byte 0, 0, 0, 1, 0, 0, 2, 0	@    ーをめがけてやっ
	.byte 4, 0, 8, 0, 0, 1, 0, 2	@    てきたんーだよ
	
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@ 62 ー　きみが
	.byte 4, 0, 8, 0, 4, 0, 8, 2	@    ぜんぜんぜんぶなく
	.byte 1, 4, 0, 8, 0, 0, 0, 0	@    ーなってーチリヂ
	.byte 0, 0, 0, 2, 0, 8, 0, 4	@    リになっーたって
	
	.byte 0, 0, 0, 2, 0, 1, 0, 4	@ 66 ー　もうーまよわ
	.byte 0, 8, 0, 2, 0, 1, 0, 4	@    ーないまたいちか
	.byte 0, 8, 0, 2, 0, 1, 0, 4 	@    ーらさがしはじめ
	.byte 0, 8, 0, 2, 0, 0, 0, 0	@    ーるさ
	
	.byte 0, 0, 0, 2, 0, 8, 0, 4	@ 70 むしろゼロ
	.byte 0, 1, 0, 2, 0, 8, 0, 4	@    ーからまたうちゅう
	.byte 0, 1, 0, 2, 0, 8, 0, 4	@    ーをはじめてみよ
	.byte 0, 1, 0, 2, 0, 0, 0, 0	@    ーうか					/45
	
	.byte 0, 0, 0, 0, 0, 0, 0, 0	@ 74
	.byte 0, 0, 0, 0, 0, 0, 0, 0
